...
published: true
---
<iframe width="900" height="506" src="https://www.youtube.com/embed/BwS6j0y1CrY" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

0:00 — как отследить в Processing нажатие клавиши клавиатуры  
1:30 — как отследить нажатие конкретной клавиши  
5:47 — как отследить нажатие стрелок и клавиш Ctrl, Alt и Shift
...
# работать не будет. u — обозначает кодировку UNICODE
...
1. «Разноцветные квадраты». На каждом кадре в случайном месте холста рисуется квадрат. При нажатии кнопки меняется цвет следующих квадратов, например, при нажатии на 1 — на красный, при нажатии на 2 — на синий и т.д.
